...
<main id="main-content">
  ...
  <section class="hero">
    <div class="container">
      ...
      <p class="hero-subtitle">
        ...
        and the fretboard — built for complete beginners, made for your phone.
      </p>
      <div class="hero-actions">
        <button type="button" id="exploreToolsBtn" class="btn btn-primary btn-block">See the Tools</button>
        <a href="#how-to-use" class="btn btn-outline btn-block">How This Site Works</a>
      </div>
    </div>
  </section>
  ...
  <section class="section" id="how-to-use" style="padding-top:0;">
    <div class="container">
      <div class="section-heading">
  ...
  <section class="section" style="background-color: var(--color-bg-alt);">
    <div class="container">
      <div class="section-heading">
        ...
        <p>Not sure where to begin? Follow this order.</p>
      </div>
  ...
  <section class="section">
    <div class="container">
      <div class="cta-banner">
        ...
        <a href="/pages/chords.php" class="btn btn-primary">Start with Chords</a>
      </div>
    </div>
  </section>
